r"""Modified version of ResNet.
The stride of conv layer in the last block is modified from 2 to 1.
"""
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, modal, num_classes=1000, zero_init_residual=False,
        ...
        self.conv1_a = nn.Conv2d(1, self.inplanes, kernel_size=7, stride=2, padding=3, bias=False)
        ...
        # Change stride 2 -> 1 (14 x 14 resolution)
...
def resnet18(pretrained=False, progress=True, modal='V', **kwargs):
...
def resnet50(pretrained=False, progress=True, modal='V', **kwargs):
    ...
    """
    assert modal in ['V', 'A']
    return _resnet('resnet50', BasicBlock, [2, 2, 2, 2], pretrained, progress, modal, **kwargs)